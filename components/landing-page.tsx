...
// Metadata mapping for known images
const galleryMetadata: Record<string, { title: string, titleBn: string }> = {
    "japanese-hamada.jpeg": { title: "Japanese Hamada Machine", titleBn: "জাপানিজ হামাদা মেশিন" },
    "chinese-cutting.jpeg": { title: "Chinese Cutting Machine", titleBn: "চাইনিজ কাটিং মেশিন" },
    "japanese-hasi.jpeg": { title: "Japanese Hasi Machine", titleBn: "জাপানিজ হাসি মেশিন" },
    "japanese-cord.jpeg": { title: "Japanese Cord Machine", titleBn: "জাপানিজ কর্ড মেশিন" },
    "pvc-machine.jpeg": { title: "PVC Machine", titleBn: "পিভিসি মেশিন" },
    "heatpress-item.jpeg": { title: "Heat Press Items", titleBn: "হিট প্রেস আইটেম" },
    "seal-item.jpeg": { title: "Rubber Seals", titleBn: "রাবার সিল" },
    "crest-item.jpeg": { title: "Crest Items", titleBn: "ক্রেস্ট আইটেম" },
    "shop.jpeg": { title: "Our Shop", titleBn: "আমাদের দোকান" },
};
...
export function LandingPage({ galleryFiles }: LandingPageProps) {
    const [isScrolled, setIsScrolled] = useState(false);
    const [showScrollTop, setShowScrollTop] = useState(false);

    // Process gallery items
    const galleryItems = galleryFiles.map((filename) => {
